        ...
        <div className="flex justify-between items-center py-4">
          ...
          <Link href="/">
            <div className="flex items-center space-x-3 cursor-pointer">
              ...
              <div>
                <h1 className="text-xl sm:text-2xl font-bold font-inter text-primary">
                  National Inspection
                </h1>

                <p className="text-xs sm:text-sm text-accent-500 font-medium">
          ...
          <Button
            asChild
            className="hidden md:flex bg-blue-800 hover:bg-blue-900 text-white font-medium py-2 px-4 rounded-md transition duration-300 shadow-md"
          >
            <Link href="/contact">
          ...
          <div className="md:hidden py-4 border-t border-gray-200">
            <nav className="flex flex-col space-y-4">
              {menuItems.map((item) => (
                <Link key={item.path} href={item.path}>
                  <span
                    className={`font-medium cursor-pointer block transition duration-300 ${
                      location === item.path
                        ? "text-accent-500"
                        : "text-primary"
                    } hover:text-accent-500`}
